...
public class StockServiceDbContext :
    AbpDbContext<StockServiceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(StockServiceConsts.DbTablePrefix + "YourEntities", StockServiceConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});

        builder.Entity<OrderCheck>(x =>
        {
            x.HasIndex(o => o.OrderId).IsUnique();
        });
    }
}
